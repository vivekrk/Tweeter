	...
	private void initializeUI() {
		...
		twitterActions.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				case R.id.showLists:
					Toast.makeText(getApplicationContext(), "Sorry!!! Lists are not implemented", Toast.LENGTH_SHORT).show();
					break;

				case R.id.showTags:
					Toast.makeText(getApplicationContext(), "Sorry!!! Tags are not implemented", Toast.LENGTH_SHORT).show();
					break;
